...
%>
${msg}
<img src='<c:url value='/resources/images/shopping 1.jpg' />'  align="right" alt="This is image" width="500" height="200">
...
<!-- <tr>
 ...
 <tr>
  ...
  <input type="submit" value="<spring:message text="Add Supplier"/>"/>
    ...
    <h3>Supplier List</h3>
   <img src='<c:url value='/resources/images/shopping 2.png' />'  align="right" alt="This is image" width="500" height="200">
