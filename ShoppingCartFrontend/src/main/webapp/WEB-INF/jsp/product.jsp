<%@page import="com.niit.shoppingcart.controller.Category"%>
...
%>
${msg}
<img src='<c:url value='/resources/images/9.jpg' />'  align="right" alt="This is image" width="500" height="400">
<h1>Add a product</h1>
<style>
table {
    width:50%;
...
<tr>
  <td><form:label path="supplier_id"><spring:message text="supplier_id"/></form:label> </td>
     ...
     <%
     java.util.List<com.niit.shoppingcart.controller.Supplier> supplierList =(java.util.List)request.getAttribute("supplier_list");
      for(com.niit.shoppingcart.controller.Supplier c:supplierList)
      {
    	 %>
    	 <option>
    	 <%
  ...
  <td> <form:label path="category_id"><spring:message text="category_id"/></form:label>  </td>
     ...
     <%
     java.util.List<Category> categoryList =(java.util.List)request.getAttribute("category_list");
